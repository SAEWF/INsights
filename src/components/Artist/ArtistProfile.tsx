...
export default function ArtistProfile(props: PropType) {
  ...
  console.log("userData", userData.length, userDataFromFireStore.length);
  if(userData.length === 0 && userDataFromFireStore.length === 0){
    return(
  ...
  else if(userData.length === 0 && userDataFromFireStore.length !== 0){
    return(
      <Container className="main-container">
